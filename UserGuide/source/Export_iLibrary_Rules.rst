...
Kappa items having for publisher: "OECD Publishing / Éditions OCDE" are currently exported with the value 'Paris' as publisher city (oecd:city). 
...
Currently no themes are exported for the following IGOs:
